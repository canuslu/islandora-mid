 ...
 */
?>
<?php drupal_add_css(drupal_get_path('theme', 'miletos_muteferriqa_mobile').'/css/islandora-newspaper-page.css'); ?>
<?php drupal_add_js(drupal_get_path('theme', 'miletos_muteferriqa_mobile').'/js/islandora-newspaper-page.js');?>
