 ...
 */
?>
<?php drupal_add_css(drupal_get_path('theme', 'miletos_muteferriqa').'/css/islandora-newspaper-issue.css'); ?>
<?php drupal_add_js(drupal_get_path('theme', 'miletos_muteferriqa').'/js/islandora-newspaper-issue.js');?>
