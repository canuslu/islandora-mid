 ...
 */
?>
<?php drupal_add_css(drupal_get_path('theme', 'miletos_muteferriqa').'/css/islandora-book-book.css'); ?>
<?php drupal_add_js(drupal_get_path('theme', 'miletos_muteferriqa').'/js/islandora-book-book.js'); ?>
<?php
...
<?php if (isset($viewer)): ?>
    ...
    <div class="main-viewer-menu-left">
        <ul id="menu-left">
            ...
            <li class="anime click-redirect" id="viewer-pages" title='<?php echo t("See all pages."); ?>'><a href="/islandora/object/<?php echo $object->id; ?>/pages"></a></li>
            <li class="anime" id="viewer-mlt" title='<?php echo t("See similar items."); ?>' data-toggle="tab" href="#detail-mlt"></li>
            ...
            <li class="anime" id="viewer-manage" title='<?php echo t("Manage object."); ?>' data-toggle="tab" href="#detail-manage"></li>
        </ul>
