...
<?php drupal_add_css(drupal_get_path('theme', 'miletos_muteferriqa').'/css/islandora-newspaper.css'); ?>

<div id="islandora-newspaper-wrapper">
<div class="col-md-6">
    <div class="islandora-newspaper-metadata">
        <div class="islandora-newspaper-thumbnail">
            <img class="img-responsive" src="<?php echo "https://" . $_SERVER['SERVER_NAME'] . $_SERVER['REDIRECT_URL'] . '/datastream/TN/view';?>">
        </div>
        <hr>
