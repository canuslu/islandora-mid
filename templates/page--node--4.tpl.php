 ...
 */
?>
<?php drupal_add_css(drupal_get_path('theme', 'miletos_muteferriqa_mobile').'/css/404.css'); ?>
...
<div class="main-container <?php print $container_class; ?>">
    <div class="centered-image">
      ...
      ?>
      <img src="/sites/all/themes/miletos_muteferriqa_mobile/images/404_en.png" onclick="goback()"/>
      <?php
          } else {
      ?>
      <img src="/sites/all/themes/miletos_muteferriqa_mobile/images/404_tr.png" onclick="goback()"/>
      <?php
          }
      ?>
    </div> 
