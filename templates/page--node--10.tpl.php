 ...
 */
?>
<?php drupal_add_css(drupal_get_path('theme', 'miletos_muteferriqa_mobile').'/css/front.css'); ?>
...
<div class="main-container <?php print $container_class; ?>">
    <div id="homepage-container">
        <div id="user-interaction-wrapper">
            <?php
                echo '<div class="slogan-wrapper-anon"><img src="/sites/all/themes/miletos_muteferriqa_mobile/images/slogan3.png"></div>';
...
<?php //if (!empty($page['footer'])):?>
  <footer class="footer <?php print $container_class; ?>">
      <div id="footer">
          <div class="col-md-12 footer-miletos footer-left">
              <span id="footer-miletos-text"><a href="/">Muteferriqa</a> by <a href="http://miletos.co"><img src="/sites/all/themes/miletos_muteferriqa_mobile/images/miletos180.png"></a>. Copyright © 2019 Miletos Inc.</span>
          </div>
          <div class="col-md-12 footer-links footer-right">
              <a href="/content/acknowledgements"><?php echo t("Acknowledgements"); ?></a> |
              <a href="/content/licenses"> <?php echo t("Licenses"); ?></a> |
              <a href="/content/terms-privacy"> <?php echo t("Terms & Privacy"); ?></a>
          </div>
      </div>
